...
// Modifications made by UnsignedChad, 10/5/2024
// Original code available at: https://www.mathematik.uni-marburg.de/~thormae/lectures/ti1/code/abacus/soroban.html
...
function AbacusCtrl(type) {
  this.type = type; // 0 Japanese, 2 five bead japanese, 3 Chinese
  
  this.beadLines = 8;

  this.beadPerLine = (this.type == 0) ? 5 : (this.type == 2) ? 6 : 7;
  this.beadSep = (this.type == 0) ? 3 : (this.type == 2) ? 4 : 4;
  ...
  console.log("beadLines: " + this.beadLines);
  console.log("beadPerLine: " + this.beadPerLine);
  console.log("beadSep: " + this.beadSep);
